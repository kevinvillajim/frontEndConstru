		...
		>
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
					{/* Company Info */}
					<div>
						<h3 className="text-xl font-heading text-white mb-4">CONSTRU</h3>
						<p className="text-gray-400 mb-4">
							Plataforma integral para profesionales de la construcción en
							Ecuador que automatiza y optimiza procesos críticos.
						</p>
				...
				{/* Bottom Bar */}
				<div className="border-t border-gray-800 pt-6 mt-8 flex flex-col md:flex-row justify-between">
